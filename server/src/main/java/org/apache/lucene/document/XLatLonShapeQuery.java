 ...
 * {@link LatLonShapeBoundingBoxQuery} and {@link XLatLonShapePolygonQuery}
 *
...
abstract class XLatLonShapeQuery extends Query {
     ...
     *   see {@link XLatLonShapeBoundingBoxQuery#relateRangeToQuery} and {@link LatLonShapePolygonQuery#relateRangeToQuery}
     */
    ...
    protected Relation relateRangeToQuery(byte[] minTriangle, byte[] maxTriangle, QueryRelation queryRelation) {
        ...
        Relation r = relateRangeBBoxToQuery(XLatLonShape.BYTES, 0, minTriangle, 3 * XLatLonShape.BYTES, 2 * XLatLonShape.BYTES, maxTriangle);
        ...
        return new ConstantScoreWeight(this, boost) {
            ...
            protected ScorerSupplier getScorerSupplier(LeafReader reader, PointValues values, Weight weight, ScoreMode scoreMode) throws IOException {
                ...
                return new RelationScorerSupplier(values, withinVisitor, disjointVisitor, queryRelation) {
                    @Override
                    public Scorer get(long leadCost) throws IOException {
                        return getScorer(XLatLonShapeQuery.this, weight, within, disjoint, score(), scoreMode);
                    }
                };
            }
